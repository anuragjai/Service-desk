...
<body>
  ...
  <div class="container-fluid topfixed" id="operationalTips" hidden>
    ...
    <div class="container topfixed" id="showteamShift" hidden>
      <!-- <h2 class="text-center">Company Name</h2>
      <hr> -->

      <div class="col-md-12 text-middle">
        <div class="col-md-12">
          <div class="col-md-3 text-center round-medium">Team's Shift
  ...
  <!-- MY Login click-->
  <div class="container topfixed" id="showteamLogin" hidden>
      <!-- <h2 class="text-center">Company Name</h2>
      <hr> -->

      <div class="col-md-12 text-middle">
        <div class="col-md-12">
          <div class="col-md-3 text-center round-medium">Team's Login
  ...
  <!-- Team Metrics start here-->


  <div class="container topfixed" id="showteamMetrics" hidden>
  <!-- <h2 class="text-center">Company Name</h2>
  <hr> -->
  ...
  <div class="col-md-12 text-middle">
    <div class="col-md-3 text-center btn btn-lg round-btn round-small">Team's CSAT
    ...
    <div class="col-md-6 pb-wrapper">
      <div class="progress">
        ...
        <div class="progress-bar progress-bar-black" role="progressbar" aria-valuenow="50"
...
<div class="col-md-12">
  <div class="col-md-3 text-center btn btn-lg round-btn round-small">Team's AHT
...
<div class="col-md-12">
  ...
  <div class="col-md-3 text-center btn btn-lg round-btn round-small">Team's RR
...
<div class="container topfixed" id="showteamTraining" hidden>
  <!-- <h2 class="text-center">Company Name</h2>
  <hr> -->
...
.datepicker({
  ...
  $("#overview").click(function(){
    ...
    $("#showteamLogin").hide();
    $("#showOverView").show();
    $("#showteamMetrics").hide();
    $("#showteamTraining").hide();
...
// To show My Metrices
$("#teamMetrics").click(function(){
  $("#showOverView").hide();
  $("#mainContent").hide();
  $("#showteamShift").hide();
  $("#showteamLogin").hide();
  $("#showteamMetrics").show();
  $("#showteamTraining").hide();
  $("#operationalTips").hide();
  $("#trainersHouse").hide();
  $("#quiz").hide();
...
// // To show My Training
$("#teamTraining").click(function(){
  $("#showOverView").hide();
  $("#mainContent").hide();
  $("#showteamShift").hide();
  $("#showteamMetrics").hide();
  $("#showteamTraining").show();
  $("#operationalTips").hide();
  $("#trainersHouse").hide();
  $("#quiz").hide();
  $("#showfooter").show();
